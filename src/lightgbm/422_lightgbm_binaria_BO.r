...
hs <- makeParamSet(
  ...
  makeIntegerParam("num_leaves", lower = 40L, upper = 2000L),
  makeNumericParam("feature_fraction", lower = 0.6, upper = 0.85),
  makeIntegerParam("min_data_in_leaf", lower = 700L, upper = 12000L),
  makeIntegerParam("max_bin", lower = 50L, upper=150L),
  makeIntegerParam("envios", lower = 1000L, upper = 17000L),
  makeNumericParam("path_smooth", lower = 200.0, upper = 300.0), 
  makeNumericParam("min_gain_to_split", lower = 0.2, upper = 0.8)
)
