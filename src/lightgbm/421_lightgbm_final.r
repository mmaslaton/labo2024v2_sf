...
PARAM$finalmodel$num_iterations <- 1642
PARAM$finalmodel$learning_rate <- 0.0111310190410719
PARAM$finalmodel$feature_fraction <- 0.160478274740471
PARAM$finalmodel$min_data_in_leaf <- 1079
PARAM$finalmodel$num_leaves <- 65

PARAM$finalmodel$path_smooth <- 70.1949089819741
PARAM$finalmodel$min_gain_to_split <- 0.272593657920399
